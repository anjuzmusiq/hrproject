...
include 'connect.php';
$email=$_POST['email'];
$s="select * from application where email='$email' and application_status='selected'";                
...
<body style="background-color:#AEEBF1">
  ...
  <tr style="height:50px">
    <th data-th="Movie Title" style="width:300px" colspan="2"><center>REGISTER EMPLOYEE DETAILS</center</th>
</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td data-th="Genre"><input type="text" class="form-control"required  name="salary" placeholder="Enter Salary">
</td>
  </tr>
  <tr>
   <th data-th="Movie Title">JOINING DATE</th>
    <td data-th="Genre"><input type="date" class="form-control"required name="join_date" placeholder="Enter Joining date">
</td>
  </tr>
  <tr>
  ...
  <tr>
   <th data-th="Movie Title">PASSWORD</th>
    <td data-th="Genre"><input id="password" name="password" class="form-control"type="password" pattern="^\S{6,}$" onchange="this.setCustomValidity(this.validity.patternMismatch ? 'Must have at least 6 characters' : ''); if(this.checkValidity()) form.password_two.pattern = this.value;" placeholder="Enter Password" required>

</td>
  </tr>
  <tr>
   <th data-th="Movie Title">CONFIRM PASSWORD</th>
    <td data-th="Genre"><input type="password" id="c_password" class="form-control" name="c_password"placeholder="Confirm Password"onchange="return Validate()"required>
    ...
    function Validate() {
        ...
        return true;
	            ...
	            <div class="form-group">
	              <input type="submit" value="INSERT DETAILS" class="btn btn-primary py-3 px-4">
				  </div>
				  </form></center>
        </div>
      </div>
