...
include("header.php");
?>   
     <div class="hero-wrap" style="background-image: url('images/detail1.jpg');" data-stellar-background-ratio="0.8	">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
		  ...
		  <form method="POST" action="edit_action.php" class="request-form ftco-animate">
