...
include("header.php");
?>   
     <div class="hero-wrap" style="background-image: url('images/leave1.jpg');" data-stellar-background-ratio="0.8	">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
		  ...
		  <form method="POST" action="leave_report_action.php" class="request-form ftco-animate">
          		<h2>LEAVE REPORT</h2>
	    				<div class="form-group">
	    					<input type="text" class="form-control" name="year" id="demo" placeholder="ENTER YEAR"required>
	    				</div>
						<div class="form-group">
