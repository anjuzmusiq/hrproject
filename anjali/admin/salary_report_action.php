...
if($month==1)
	...
	$v_month='December';
?>  
    <div class="hero-wrap" style="background-image: url('images/sal.jpg');" data-stellar-background-ratio="0.4	">
...
<form method="POST" action="salary_action.php" class="request-form ftco-animate">
          		<h2>SALARY REPORT <?php echo $v_month," ",$year;?></h2>
<center>
<table class="rwd-table" border="1">
			...
			<th style="width:550px">DESIGNATON</th>
			<th style="width:550px">DA</th>
			<th style="width:550px">HRA</th>
			<th style="width:550px">PF</th>
			<th style="width:550px">NO OF LEAVES</th>
			<th style="width:550px">BASIC SALARY</th>
			<th style="width:550px">NETPAY</th>
...
<tr>
			...
			<td data-th="Movie Title"style="width:550px"><?php echo $row[12];?></td>
			<td data-th="Genre"style="width:550px"><?php echo $row[13];?></td>
			<td data-th="Genre"style="width:550px"><?php echo $row[15];?></td>
			<td data-th="Genre"style="width:550px"><?php echo $row[16];?></td>
			<td data-th="Year"style="width:550px"><?php echo $row[6];?></td>
			<td data-th="Gross"style="width:550px"><?php echo $row[8];?></td>
			<td data-th="Gross"style="width:5000px"><?php echo $row[7];?></td>
			<td data-th="Gross"style="width:5000px"><?php echo $row[5];?></td>
			<td data-th="Gross"style="width:5000px"><?php echo $row[4];?></td>
			<td data-th="Gross"style="width:5000px"><?php echo $row[9];?></td>
