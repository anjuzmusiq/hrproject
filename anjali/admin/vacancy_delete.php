...
include("header.php");
?>  
    <div class="hero-wrap" style="background-image: url('images/detail1.jpg');" data-stellar-background-ratio="0.4	">
...
<br>
<br>
          	<form method="POST" action="vacancy_delete_action.php" class="request-form ftco-animate">
          		<h2>DELETE VACANCY</h2>
						<div class="form-group">
							<label>Department</label>
							<select class="form-control" name="dept_id"required>
							<option value="1">Account and Finance</option>
						...
						<div class="form-group">
							...
							<select class="form-control" name="desig_id"required>
						...
						<div class="form-group">
							<label>Vacancy</label>
							<select class="form-control" name="vacancy_status"required>
